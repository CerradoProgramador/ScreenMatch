...
public class PrincipalComBusca {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        while (!busca.equalsIgnoreCase  ("sair")) {
            ...
            String endereco = "https://www.omdbapi.com/?t=" + busca.replace(" ", "+") + "&apikey=726344e1";
            ...
            try {
                ...
                System.out.println("----TituloOMBD convertido para Titulo---- ");
                ...
                System.out.println("Errou no argumento da url!");
